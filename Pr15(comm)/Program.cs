string s1 = "Hello, World!"; // объявление строки
...
string t1 = "John"; string t2 = "John"; string t3 = "Mary"; // перечисление строк t1 t2 t3
...
foreach (var s in "1 2 3".Split(' ')) // вывод на экран указанной строки из цифр, с использованием оператора foreach
    Console.WriteLine(s); // вывод на экран значения s
foreach (var s in "1 2 3-4-5-6".Split(new char[] { ' ', '-' })) // вывод на экран разделения указанной выше строки
    Console.WriteLine(s); // вывод на экран значения s
